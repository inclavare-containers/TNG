...
/// ITA evidence (TDX quote + nonce + runtime_data + optional GPU evidence)
#[allow(dead_code)]
pub const OCBR_TAG_EVIDENCE_ITA_EVIDENCE: u64 = 0x17A000;
/// ITA token (JWT from Intel Trust Authority)
#[allow(dead_code)]
pub const OCBR_TAG_EVIDENCE_ITA_TOKEN: u64 = 0x17A001;
...
impl From<HashAlgo> for HashAlgoIanaId {
    fn from(val: HashAlgo) -> Self {
        match val {
            HashAlgo::Sha256 => 1,
            HashAlgo::Sha384 => 7,
            HashAlgo::Sha512 => 8,
