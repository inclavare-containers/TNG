...
use super::cert_verifier::{coco::ServerCertVerifier, dummy::DummyServerCertVerifier};
        ...
        let mut config =
            match self {
                ...
                TlsConfigGenerator::Verify(verify_args) => {
                    ...
                    let verifier: Arc<ServerCertVerifier> =
                        Arc::new(ServerCertVerifier::new(verify_args.clone())?);
                    tls_client_config
                        .dangerous()
...
pub struct OnetimeTlsClientConfig(
    ...
    pub Option<Arc<ServerCertVerifier>>,
);
