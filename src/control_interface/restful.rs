...
impl RestfulControlInterface {
    pub async fn serve(args: RestfulArgs, core: Arc<ControlInterfaceCore>) -> Result<()> {
        ...
        let addr = (
            args.address.host.unwrap_or("0.0.0.0".to_string()),
            args.address.port,
        );
        info!(
        ...
        info!("Restful Control interface stopping");
