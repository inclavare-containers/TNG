...
const STRINGS = {
  en: {
    ...
    "tng.builtin.policy.hardware_only_strict": "Hardware only, strict",
    "tng.builtin.policy.hardware_with_reference_values": "Hardware + reference values",
    "tng.builtin.policy.hardware_strict_with_reference_values": "Hardware strict + reference values",
  ...
  zh: {
    ...
    "tng.builtin.policy.hardware_only_strict": "仅硬件，严格",
    "tng.builtin.policy.hardware_with_reference_values": "硬件 + 参考值",
    "tng.builtin.policy.hardware_strict_with_reference_values": "严格硬件 + 参考值",
