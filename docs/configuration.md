...
Currently, TNG supports the following types of exporters, and other Metrics export methods (such as Prometheus, etc.) are under development.

> **`stdout`**: Print to log output
> **`falcon`**: Export to open-falcon service
